...
[theta2, J_history] = gradientDescentMulti(X, y, theta, alpha1, num_iters);
...
[theta3, J_history] = gradientDescentMulti(X, y, theta, alpha2, num_iters);
...
[theta4, J_history] = gradientDescentMulti(X, y, theta, alpha3, num_iters);
